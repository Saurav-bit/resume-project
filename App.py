        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if resume_data['no_of_pages'] == 1:
                    cand_level = "Fresher"
                    st.markdown( '''<h4 style='text-align: left; color: 	#FF0000;'>You are looking Fresher.</h4>''',unsafe_allow_html=True)
                ...
                if 'Objective' in resume_text:
                    ...
                    st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add your career objective.</h4>''',unsafe_allow_html=True)
